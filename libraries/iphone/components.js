...
prx.types.toolbar = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<div class="inner liveUpdate-backgroundColor-background-color changeProperty-backgroundColor">';
        cR += '</div>';
...
prx.types.header = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#' + _id + ' {background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+';text-align: center;line-height:'+_dims.height+'px;'+_props+' text-shadow: 0 -1px 0 rgba(0,0,0,0.5);}';
        cR += '</style>';
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
        cR += '<div class="inner liveUpdate-backgroundColor-background-color liveUpdate-textColor-color changeProperty-backgroundColor changeProperty-textFont changeProperty-textFontStyle changeProperty-textSize changeProperty-textColor"><span data-editableproperty="text">'+prx.componentsHelper.getProp(item.text,'text')+'</span>';
        cR += '</div>';
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
        cR += '</div>';
        return cR;
...
prx.types.tabbar = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        $.each(item.tabs, function(i,elm){
            ...
            // if(prx.componentsHelper.getProp(item.maskIcons,'boolean') && $.browser.webkit && !prx.editor) {
            if(prx.componentsHelper.getProp(item.maskIcons,'boolean') && !prx.editor) {
                var assetPathWithMaskEnabled = prx.componentsHelper.maskImageFixForSafari11(elm.icon);
                _icon += '-webkit-mask-image: url('+assetPathWithMaskEnabled+'); background: -webkit-gradient(linear, left top, left bottom, from(#555555), to(#666666));';
            } else {
...
prx.types.button2 = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        if(typeof(item.textFontStyle) == "undefined") { item.textFontStyle = 400; }
        ...
        if(prx.componentsHelper.getProp(item.arrowDirection,'other') == 'left') {
            cR = cR + '<div class="button-arrow" style="overflow: hidden; height: 100%; width: '+Math.round(_dims.height/2)+'px; '+prx.componentsHelper.getProp(item.arrowDirection,'other')+': 0; position: relative;"><div class="liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color changeProperty-borderColor changeProperty-backgroundColor changeProperty-borderWidth" style="height: '+arrow_h+'px; width: '+arrow_h+'px; '+arr+' top: '+arrow_pos+'px; '+bgArrCss+'"></div></div>';
        }
        cR = cR + '<div class="button-content liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color liveUpdate-textColor-color changeProperty-backgroundColor changeProperty-borderColor changeProperty-borderWidth changeProperty-borderRadius changeProperty-textColor changeProperty-textFont changeProperty-textSize" style="'+content+' height: 100%; '+bgBtnCss+' '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+_props+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px;"><span style="'+text+' margin-'+prx.componentsHelper.getProp(item.arrowDirection,'other')+': -'+eval(content_left/2)+'px;">'
        ...
        if(prx.componentsHelper.getProp(item.arrowDirection,'other') == 'right') {
            cR = cR + '<div class="button-arrow" style="overflow: hidden; height: 100%; width: '+Math.round(_dims.height/2)+'px; '+prx.componentsHelper.getProp(item.arrowDirection,'other')+': 0;"><div class="liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color changeProperty-borderColor changeProperty-borderWidth changeProperty-backgroundColor" style="height: '+arrow_h+'px; width: '+arrow_h+'px; '+arr+' top: '+arrow_pos+'px; '+bgArrCss+'"></div></div>';
        }
        cR = cR + '</div>';
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
        cR = cR + '</div>';
    ...
    ,propertyGroups:
        [
            ...
            properties: [
                [
                    {
                        caption: { label: 'Font family', class: 'text-properties-android_notification_item text-fontfamily-label' },
                        name: 'textFont',
                ...
                [
                    {
                        ...
                        ,onChange: function(item){
                            ...
                            if(item.iconpos == 'notext') {
                                $('#property-textFont, #property-textSize, #property-textFontStyle, #property-textColor, #property-textProperties, #property-shadowColor').hide();
                            } else {
                                $('#property-textFont, #property-textSize, #property-textFontStyle, #property-textColor, #property-textProperties, #property-shadowColor').show();
                            }
...
prx.types.fullwidthbutton = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#' + _id + ' .inner-btn { ' + _btnBg+';font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+_props+'; background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+'; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; border-color: '+prx.componentsHelper.getProp(item.borderColor,'color-border')+';line-height: '+(parseInt(prx.componentsHelper.getRealDims(item,symbol).height)-6*prx.componentsHelper.getScale(item))+'px; }';
        cR += '</style>';
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
        cR += '<div class="inner-btn liveUpdate-backgroundColor-background-color liveUpdate-textColor-color liveUpdate-borderColor-border-color changeProperty-text changeProperty-textFontStyle changeProperty-backgroundColor changeProperty-textColor changeProperty-textFont changeProperty-textSize changeProperty-borderColor">';
...
prx.types.buttongroup = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '</style>';
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
        cR += '<div class="button-content liveUpdate-textColor-color liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color changeProperty-borderRadius changeProperty-textColor changeProperty-textFontStyle changeProperty-borderColor changeProperty-backgroundColor changeProperty-textFont changeProperty-textSize" style="'+content+' height: 100%; '+bgBtnCss+' line-height: '+eval(_dims.height-prx.componentsHelper.getProp(item.borderWidth,'num-border-width')*2)+'px; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+_props+'; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'size-text-size')+'px; '+text+'">'
        $.each(item.buttons, function(i,elm){
            ...
            cR += '<span id="'+_id+'-buttons-'+i+'" style="'+_span+'" class="liveUpdate-borderColor-border-color changeProperty-borderColor dynamic-property" data-dynamic-property-index="'+i+'">';
            switch(prx.componentsHelper.getProp(item.iconpos,'icon-position')) {
                case 'left':
                case 'right':
				...
				[
                    {
                        ...
                        pffSettings: prx.commonproperties.pffSettingsTextFontStyle,
                        value: function(item,name) {
                            if(item.textFontStyle === undefined){
                                item.textFontStyle = '700';
                            }
                        ...
                        ,changeProperty: {
                            caption: 'Text font Style',
                            selector: '.changeProperty-textFontStyle',
                            property: 'font-style',
                            transitionable: false
                        }
                    },
...
prx.types.segmentedcontrol = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<ul class="label-container liveUpdate-borderColor-border-color liveUpdate-backgroundColor-background-color liveUpdate-textColor-color changeProperty-backgroundColor changeProperty-textColor changeProperty-textFont changeProperty-textFontStyle changeProperty-textSize changeProperty-borderColor" style="'+bgBtnCss+' background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+_props+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; border-color: '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; border-radius: '+prx.componentsHelper.getProp(item.borderRadius,'border-radius')+';">';
        $.each(item.options, function(i,elm){
            ...
            cR +='<label data-dynamic-property-index="'+i+'" class="dynamic-property liveUpdate-borderColor-border-color changeProperty-borderColor '+((prx.componentsHelper.getProp(item.selected,'num-other') == i) ? 'liveUpdate-activeTextColor-color liveUpdate-activeBackgroundColor-background-color' : '')+'" for="'+_id+'-radio-'+i+'" style="'+_style+' border-color: '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'"><span data-editableproperty="text" data-dynamic-property-index="'+i+'">'+prx.componentsHelper.getProp(elm.text,'text')+'</span></label>';
            cR += '</li>';
        });
        cR += '</ul>';
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
    ...
    ,propertyGroups:
        [
            ...
            properties: [
                ...
                [
                     prx.commonproperties.textProperties
                    ,prx.commonproperties.textColor('Default'),
					{
...
prx.types.pagecontroller = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        $.each(item.buttons, function(i,elm){
            ...
            cR += '<label for="'+_id+'-option-'+i+'" id="'+_id+'-buttons-'+i+'" class="page '+((i == prx.componentsHelper.getProp(item.selected,'num-other')) ? 'liveUpdate-activeButtonColor-background-color' : 'liveUpdate-buttonColor-background-color')+' dynamic-property" data-dynamic-property-index="'+i+'"></label>'
            cR += '</li>';
        });
...
prx.types.label = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        var cR = '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-text   changeProperty-textColor changeProperty-textFont changeProperty-textSize changeProperty-textAlign">';

        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#' + _id + '{color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+'; '+_props+_shadow+' text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+';}';
        cR += '</style>';
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);

        cR += '<div style="overflow: hidden; width: 100%; height: 100%;" class="liveUpdate-textColor-color liveUpdate-backgroundColor-background-color changeProperty-text changeProperty-backgroundColor"> <span data-editableproperty="text">'+prx.componentsHelper.getProp(item.text,'text')+'</span>';
        cR += '</div>';
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
        cR += '</div>';
        return cR;
    ...
    ,afterDisplay: function(item,containerid,symbol) {
		...
		if(!prx.editor) {
			$('#'+_id)
				...
				.keyup(function(e){
					if(typeof(prx.variables._triggerData['#'+_id]) == "undefined") { prx.variables._triggerData['#'+_id] = {}; }
			        prx.variables._triggerData['#'+_id]['inputkeyup'] = { value: $(this).val() };var event = $.Event("inputkeyup");
					event.which = e.which;
					$('#'+_id).trigger(event);
				});
...
prx.types.radiobutton = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<label class="liveUpdate-backgroundColor-background-color changeProperty-backgroundColor" for="'+_id+'-checkbox" style="'+_bg+'" for="'+_id+'-checkbox" style="'+_bg+'" data-clickable="true"><span class="liveUpdate-backgroundColor-background-color changeProperty-backgroundColor" style="'+_bg+'"></span></label>';
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
        cR += '</div>';
        return cR;
    }
...
prx.types.checkbox = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        var _bg = 'background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+';';
        var _check = '<span class="liveUpdate-activeColor-color changeProperty-activeColor" style="font-size: '+prx.componentsHelper.getProp(item.height,'num-other')+'px; color: '+prx.componentsHelper.getProp(item.activeColor,'color-text')+';">&#10004;</span>';
        var _active = "";
        ...
        cR += '<label for="'+_id+'-checkbox" class="liveUpdate-backgroundColor-background-color changeProperty-backgroundColor" style="'+_bg+' display: block; width: 100%; height: 100%;" data-clickable="true">'+_check+'</label>';
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
        cR += '</div>';
        return cR;
    }
...
prx.types.checkboxlist = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<div class="label-container liveUpdate-backgroundColor-background-color liveUpdate-textColor-color liveUpdate-borderColor-border-color changeProperty-backgroundColor changeProperty-textColor changeProperty-borderColor changeProperty-textFont changeProperty-textFontStyle changeProperty-textSize changeProperty-textAlign '+_hor+'" style="background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; border-color: '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; border-radius:'+prx.componentsHelper.getProp(item.borderRadius,'border-radius')+'; '+_props+' text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+';">';
        ...
        $.each(item.checkboxes, function(i,elm){
            ...
            cR += '<label data-dynamic-property-index="'+i+'" class="dynamic-property liveUpdate-borderColor-border-color changeProperty-borderColor changeProperty-activeBackgroundColor changeProperty-activeTextColor '+((prx.componentsHelper.getProp(elm.active,'boolean')) ? 'liveUpdate-activeBackgroundColor-background-color liveUpdate-activeTextColor-color' : '')+'" for="'+_id+'-checkbox-'+i+'" style="'+_style+' border-color: '+prx.componentsHelper.getProp(item.borderColor,'color-border')+';"><span data-editableproperty="text" data-dynamic-property-index="'+i+'">' +prx.componentsHelper.getProp(elm.text,'text')+ '</span>' + _checkmark + '</label>'
            cR += '</span>';
        });
        cR += '</div>';
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
...
prx.types.flipswitch = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<span class="activelabel liveUpdate-activeLabelColor-background-color liveUpdate-activeLabelTextColor-color"><span data-editableproperty="activeLabelText">'+prx.componentsHelper.getProp(item.activeLabelText,'text')+'</span></span>';
        cR += '<span class="inactivelabel liveUpdate-inactiveLabelColor-background-color liveUpdate-inactiveLabelTextColor-color"><span data-editableproperty="inactiveLabelText">'+prx.componentsHelper.getProp(item.inactiveLabelText,'text')+'</span></span>';
        cR += '</div>';
...
prx.types.picker = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        var cR = '<div id="' + _id + '" ' + prx.items.getComponentBaseAttributes(item, containerid, symbol)  + ' class="' + prx.items.getComponentBaseClasses(item, containerid, symbol) + ' box pos type-picker"><div class="outer liveUpdate-containerColor-background-color" style="background-color: '+prx.componentsHelper.getProp(item.containerColor,'color-background')+';">';
        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '</style>';
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);
        ...
        cR += '<div class="inner liveUpdate-listColor-background-color liveUpdate-textColor-color changeProperty-textColor changeProperty-textFont changeProperty-textFontStyle" id="' + _id + '-inner" style="background-color: '+prx.componentsHelper.getProp(item.listColor,'color-background')+'; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+' '+_props+'">';
        ...
        for(var i = 0; i < _options.length; i++) {
            if(prx.componentsHelper.getProp(item.showBar,'boolean')) {
                ...
                cR += '<li><input type="radio" data-role="none" id="'+_id+'-option'+i+'" name="'+_id+'-input" '+((i == prx.componentsHelper.getProp(item.selectedValue,'num-other')) ? 'checked' : '' )+'/><label '+((i == prx.componentsHelper.getProp(item.selectedValue,'num-other')) ? 'class="liveUpdate-activeTextColor-color"' : '' )+' for="'+_id+'-option'+i+'"><span>&#10004;</span>' + _options[i] + '</label></li>';
            }
        };
        cR += '</ul>'

        if(prx.componentsHelper.getProp(item.showBar,'boolean')) {
            cR += '<div class="bar liveUpdate-barColor-background-color" style="background-color: '+prx.componentsHelper.getProp(item.barColor,'color-background')+';"></div>';
        } else {
...
prx.types.listcomplex = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        if(typeof(item.textFontStyle) == 'undefined') item.textFontStyle = '400';
        if(typeof(item.subFontStyle) == 'undefined') item.subFontStyle = '400';
        if(typeof(item.badgeFontStyle) == 'undefined') item.badgeFontStyle = '400';
        ...
        cR += '<style>';
        cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#' + _id + ' .label-container { '+_style+'text-align: '+prx.componentsHelper.getProp(item.textAlign,'align')+'; background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+'; '+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; border: '+prx.componentsHelper.getProp(item.borderWidth,'num-border-width')+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; border-radius: '+_borderRadius+'; }';
        ...
        cR += '#' + _id + ' li .value { height: '+_height+'px; '+prx.componentsHelper.getProp(item.valueFont + '|' + item.valueFontStyle,'font-family')+_valueprops+'; font-size: '+prx.componentsHelper.getProp(item.valueSize,'num-text-size')+'px; color: '+prx.componentsHelper.getProp(item.valueColor,'color-text')+'; padding-left: '+(10*prx.componentsHelper.getScale(item))+'px; }'
        cR += '#' + _id + ' li .subtitle { '+prx.componentsHelper.getProp(item.subFont + '|' + item.subFontStyle,'font-family')+_subprops+' font-size: '+prx.componentsHelper.getProp(item.subSize,'num-text-size')+'px; color: '+prx.componentsHelper.getProp(item.subColor,'color-text')+'; }'
        cR += '</style>';
        cR += prx.items.getComponentPrependDivs(item, containerid, symbol);

        cR += '<ul class="label-container liveUpdate-borderColor-border-color liveUpdate-textColor-color liveUpdate-backgroundColor-background-color changeProperty-backgroundColor changeProperty-textColor changeProperty-borderColor changeProperty-textAlign changeProperty-textFont changeProperty-textSize">';
        ...
        $.each(item.listitems, function(i,elm){
            ...
            if( prx.componentsHelper.getProp(elm.itemtype,'other') == 'withValue' ||
                ...
                _inactivevalue = '<span class="va-outer"><span class="va-inner value liveUpdate-valueColor-color"><span data-editableproperty="value" data-dynamic-property-index="'+i+'">'+prx.componentsHelper.getProp(elm.value,'text')+'</span></span></span>';
            }
            /* /VALUES */

            /* SUBTITLES */
            if(typeof(elm.subtitle) != "undefined" && prx.componentsHelper.getProp(elm.subtitle,'other') != "") {
                _inactivetext += '<span class="subtitle '+ ((prx.componentsHelper.getProp(elm.itemtype,'other') == 'checkbox' && prx.componentsHelper.getProp(elm.checked,'boolean')) ? 'liveUpdate-activeSubColor-color' : 'liveUpdate-subColor-color') +'"><span data-editableproperty="subtitle" data-dynamic-property-index="'+i+'">'+prx.componentsHelper.getProp(elm.subtitle,'text')+'</span></span>'
            }
            /* /SUBTITLES */
            ...
            cR += '<label '+ ((prx.componentsHelper.getProp(elm.itemtype,'other') == 'checkbox' && prx.componentsHelper.getProp(elm.checked,'boolean')) ? 'class="liveUpdate-activeTextColor-color liveUpdate-activeBackgroundColor-background-color"' : '') +' for="'+_id+'-checkbox-'+i+'">' +_icon + _thumbnail + _badge + _inactivevalue + _inactivetext+'</label>';
            cR += '</li>';
            ...
            properties: [
                [
                ...
                ],[
                    {
                        caption: { label: 'Font style', class: 'text-properties-label text-fontstyle-label' },
                        name: 'subFontStyle',
                        proptype: 'font-style-2-subtitle',
                        type: 'select',
                        pffSettings: prx.commonproperties.pffSettingsTextFontStyle,
                        value: function(item,name) {
                            if(typeof item.subFontStyle == 'undefined'){
                                item.subFontStyle = '400';
                            }
                            return item.subFontStyle;
                        },
                        values: function() {
                            return prx.comps.fontStyles;
                        }
				...
				[
                    {
                        ...
                        caption: { label: 'Font style', class: 'text-properties-label text-fontstyle-label' },
                        name: 'valueFontStyle',
                        proptype: 'font-style-3-value',
                        type: 'select',
						pffSettings: prx.commonproperties.pffSettingsTextFontStyle,
                        value: function(item,name) {
                            return typeof item.valueFontStyle == 'undefined' ? '400' : item.valueFontStyle;
                        },
                        values: function() {return prx.comps.fontStyles; }
                        ,changeProperty: {
                            caption: 'Value font style',
                            property: 'font-style',
                            selector: '.value',
                            transitionable: false
                        }
                ...
                ],[
                    {
                        ...
                        value: function(item,name) {
                            ...
                            return item.valueProperties;
                        },
                        values: [
                            { value: 'underline', displayValue: '', icon: 'text-underline'}
                        ]
                        ,changeProperty: {
                            caption: 'Value underline',
                            rerender: true,
                            changeable: false
                        }
            ...
            properties: [
                [
					...
					[
                    {
                        caption: { label: 'Font style', class: 'text-properties-label text-fontstyle-label' },
                        name: 'badgeFontStyle',
                        proptype: 'font-style-3-badge',
                        type: 'select',
						pffSettings: prx.commonproperties.pffSettingsTextFontStyle,
                        value: function (item, name) {
                            return typeof item.badgeFontStyle == 'undefined' ? '400' : item.badgeFontStyle;
                        },
                        values: function () {
                            return prx.comps.fonts;
                        }
                        , changeProperty: {
                            caption: 'Badge font style',
                            property: 'font-style',
                            selector: '.badge',
                            transitionable: false
                        }
                ...
                ],[
                    {
                        ...
                        value: function(item,name) {
                            ...
                            return item.badgeProperties;
                        },
                        values: [
                            { value: 'underline', displayValue: '', icon: 'text-underline'}
                        ]
                        ,changeProperty: {
                            caption: 'Badge underline',
                            rerender: true
                        }
                    }
                   ,{
...
prx.componentsHelper.removeProperties(prx.types.listnested.propertyGroups, ['valueFont', 'valueSize', 'valueColor', 'valueFontStyle', 'valueProperties', 'activeValueColor', 'badgeFont', 'badgeFontStyle', 'badgeSize', 'badgeColor', 'badgeProperties', 'badgeGlassStyle', 'badgeBackgroundColor'])
...
prx.componentsHelper.removeProperties(prx.types.listwithiconandvalue.propertyGroups, [/*'subFont', 'subSize', 'subColor', 'subProperties', 'activeSubColor',*/ 'badgeFont', 'badgeFontStyle', 'badgeSize', 'badgeColor', 'badgeProperties', 'badgeGlassStyle', 'badgeBackgroundColor'])
...
prx.componentsHelper.removeProperties(prx.types.listnestedwithbadge.propertyGroups, ['valueFont', 'valueFontStyle', 'valueSize', 'valueColor', 'valueProperties', 'activeValueColor'])
...
prx.types.actionsheet = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<div  class="actionsheet-inner liveUpdate-backgroundColor-background-color changeProperty-backgroundColor"  style="padding: '+prx.componentsHelper.getProp(item.padding,'num-other')+'px; '+_bg+' background-size: 100% '+20*prx.componentsHelper.getScale(item)+'px; background-repeat: no-repeat; background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+';">';
        $.each(item.buttons, function(i,elm){
            cR += '<div id="'+_id+'-buttons-'+i+'" class="dynamic-property actionsheet-button liveUpdate-backgroundColor-'+i+'-background-color liveUpdate-textColor-'+i+'-background-color" data-dynamic-property-index="'+i+'"  style="'+_btnBg+'; background-color: '+prx.componentsHelper.getProp(elm.backgroundColor,'color-background')+'; color: '+prx.componentsHelper.getProp(elm.textColor,'color-text')+';"><span data-editableproperty="text" data-dynamic-property-index="'+i+'">'+prx.componentsHelper.getProp(elm.text,'text')+'</span></div>';
        });
        cR += '</div>';
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
        cR += '</div>';
...
prx.types.progressview = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        cR += '<div class="slider-bar liveUpdate-barColor-background-color" style="height: 100%; background-color: '+prx.componentsHelper.getProp(item.barColor,'color-background')+';">';
        cR += '<div class="slider-bar-filled liveUpdate-fillBarColor-background-color" style="width: '+prx.componentsHelper.getProp(item.progress,'num-percentage')+'%; background-color: '+prx.componentsHelper.getProp(item.fillBarColor,'color-background')+'";></div>'
        cR += '</div>';
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
        cR += '</div>';
        return cR;
...
prx.types.popover = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        ...
        if(eval(prx.componentsHelper.getProp(item.hasHeader,'boolean'))) {
            cR += '<div class="popover-header liveUpdate-borderColor-background-color liveUpdate-textColor-color changeProperty-textFont changeProperty-textColor changeProperty-textFontStyle" style="line-height: '+(30*prx.componentsHelper.getScale(item))+'px; height: '+(25*prx.componentsHelper.getScale(item))+'px; background-color: '+prx.componentsHelper.getProp(item.borderColor,'color-background')+'; padding: '+(5*prx.componentsHelper.getScale(item))+'px 0; text-align: center;'+prx.componentsHelper.getProp(item.textFont + '|' + item.textFontStyle,'font-family')+'; color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+';' +_props+';  font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; border-radius: ' + prx.componentsHelper.getProp(item.borderRadius,'border-radius-tl')+ ' '+prx.componentsHelper.getProp(item.borderRadius,'border-radius-tr')+ ' 0 0;"><span data-editableproperty="text">'+prx.componentsHelper.getProp(item.text,'text')+'</span></div>';
        }
        cR += '<div class="popover-content liveUpdate-backgroundColor-background-color liveUpdate-borderColor-border-color changeProperty-backgroundColor" style="height: '+_height2+'; '+_borderRadius+' border: '+(5*prx.componentsHelper.getScale(item))+'px solid '+prx.componentsHelper.getProp(item.borderColor,'color-border')+'; background-color: '+prx.componentsHelper.getProp(item.backgroundColor,'color-background')+'"></div>';
        cR += '</div>';
        cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
        cR += '</div>';
                ...
                [
                    {
                        ...
                        ,onChange: function(item) {
                            if(item.hasHeader) {
                                $('#property-textFont, #property-textFontStyle, #property-textProperties, #property-textColor').show()
                            } else {
                                $('#property-textFont, #property-textFontStyle, #property-textProperties, #property-textColor').hide()
                            }
                            return false;
                        }
                        ,changeProperty: {
					...
					[
                    {
						...
						pffSettings: prx.commonproperties.pffSettingsTextFontStyle,
                        value: function(item, name) {
                            return typeof item.textFontStyle == 'undefined' ? '400' : item.textFontStyle;
                        },
                        values: function(){ return prx.comps.fontStyles },
                        hiddenByDefault: function(item){
                            return (!item.hasHeader)
...
prx.components.tabbar = {
    ...
    ,resizable : true
    ,resizeHandles : "e,w"
    ,properties: "v,l,hpos,vpos,w,r,dr,f,ds"
    ,overlay: false
    ,maskIcons: true
}
